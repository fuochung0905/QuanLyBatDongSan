  ...
  return (
    <div style={{ height: 400, width: '100%' }}>
      ...
      >
        ...
        <DialogActions>
          <Button className='btn-wrap btn-end' onClick={handleCloseInsert} color="secondary">
            Hủy
          </Button>
          <Button className='btn-wrap btn-save' onClick={handleSave} color="primary">
            Lưu
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={openDeleteConfirm} onClose={handleCloseDeleteConfirm}>
        ...
        <DialogActions>
          <Button className='btn-wrap btn-end' onClick={handleCloseDeleteConfirm} color="secondary">
            Hủy
          </Button>
          <Button className='btn-wrap btn-save' onClick={handleDelete} color="primary">
            Xóa
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogActions>
          <Button className='btn-wrap btn-end' onClick={handleClose} color="secondary">
            Hủy
          </Button>
          <Button className='btn-wrap btn-save' onClick={handleSave} color="primary">
            Lưu
