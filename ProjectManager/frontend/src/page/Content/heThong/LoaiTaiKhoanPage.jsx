...
function LoaiTaiKhoanPage() {
    ...
    const columns = [
      ...
      { field: 'Ma', headerName: 'Mã', width: 200 },
    ...
    const rows = [
      { id: 1, Ma: 'DEV BE', TenGoi: 'BackEnd Developer ' },
      { id: 2, Ma: 'DEV FE', TenGoi: 'FrontEnd Developer' },
      { id: 3, Ma: 'DEV FULLSTASK', TenGoi: 'Software Developer' },
      { id: 4, Ma: 'TEST', TenGoi: 'Tester' }
    ];
